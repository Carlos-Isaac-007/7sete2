...
<h3><i class="fa-solid fa-cart-shopping"></i> <?php echo LANG_VALUE_25; ?></h3>
...
// pegando email do cliente
$custmer_eamil = $_SESSION['customer']['cust_email'];

$statement->execute(array($custmer_eamil));
$total_pages = $statement->rowCount();

$targetpage = URL.'customer-order.php';
$limit = 10;

// verificando se a variavel page tem valor
...
echo 'Nome do produto: '.$row1['product_name'];
echo '<br>Tamanho: '.$row1['size'];
echo '<br>Cor: '.$row1['color'];
echo '<br>Quantidade: '.$row1['quantity'];
echo '<br>Preço Unitário: '.$row1['unit_price'].' KZ';
echo '<br><br>';
}
?>
</td>
