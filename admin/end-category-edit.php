...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'A categoria de nível final foi atualizada com sucesso.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Editar categoria de nível final</h1>
	</div>
	<div class="content-header-right">
		<a href="end-category.php" class="btn btn-primary btn-sm">Ver tudo</a>
	</div>
</section>
