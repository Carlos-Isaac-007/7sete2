...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_name'])) {
    	...
    	{
    		$valid = 0;
        	$error_message .= "Nome da Provincia ja existe exists<br>";
    	}
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Provincia Adicionado com sucesso.';
    }
}
?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Nome da Provincia <span>*</span></label>
							<div class="col-sm-4">
