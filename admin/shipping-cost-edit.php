...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_id'])) {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Provincia selecionada já existe<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Custo de envio atiualizado com sucesso.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Editar Custo de Envio</h1>
	</div>
	<div class="content-header-right">
		<a href="shipping-cost.php" class="btn btn-primary btn-sm">Ver Todos</a>
	</div>
</section>
