...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['color_name'])) {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'CNome da Cor ja existe<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Cor atualizado com sucesso.';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="color.php" class="btn btn-primary btn-sm">Ver Todos</a>
	</div>
</section>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Nome da Cor <span>*</span></label>
                    <div class="col-sm-4">
