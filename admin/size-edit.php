...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['size_name'])) {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Nome do Tamanho ja existe<br>';
    	}
    }
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="size.php" class="btn btn-primary btn-sm">Ver Todos</a>
	</div>
</section>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Nome do Tamanho <span>*</span></label>
                    <div class="col-sm-4">
