...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
        $valid = 0;
        $error_message .= "O nome da categoria principal não pode estar vazio<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'O nome da categoria principal já existe<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'A categoria principal foi atualizada com sucesso.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Editar categoria de nível superior</h1>
	</div>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Nome da categoria principal<span>*</span></label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    Mostrar no menu? <span>*</span></label>
                    <div class="col-sm-4">
                        <select name="show_on_menu" class="form-control" style="width:auto;">
                            <option value="0" <?php if($show_on_menu == 0) {echo 'selected';} ?>>Não</option>
                            <option value="1" <?php if($show_on_menu == 1) {echo 'selected';} ?>>Sim</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
