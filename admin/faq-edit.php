...
$valid = 0;
$error_message .= 'Adicionar perguntas frequentes<br>';
}
...
$success_message = 'FAQ foi atualizada com sucesso!';
}
}
?>
...
<h1>Editar perguntas frequentes</h1>
</div>
<div class="content-header-right">
<a href="faq.php" class="btn btn-primary btn-sm">Ver Todos</a>
</div>
</section>
...
<label for="" class="col-sm-2 control-label">Titulo <span>*</span></label>
<div class="col-sm-6">
