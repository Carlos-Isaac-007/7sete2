...
if($_SESSION['user']['role'] == 'Super Admin' || 'Admin' || 'vendedor') {

$valid = 1;

if(empty($_POST['full_name'])) {
$valid = 0;
$error_message .= "O nome não pode estar vazio<br>";
}

if(empty($_POST['email'])) {
$valid = 0;
$error_message .= 'O endereço de e-mail não pode estar vazio<br>';
} else {
if (filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) === false) {
$valid = 0;
$error_message .= 'O endereço de e-mail deve ser válido<br>';
} else {
...
if($total) {
$valid = 0;
$error_message .= 'O endereço de e-mail já existe<br>';
}
}
}
...
$success_message = 'As informações do usuário foram atualizadas com sucesso.';
...
$success_message = 'A foto foi atualizado com sucesso.';
header("Location:".BASE_URL);
die;
}
}
...
$valid = 0;
$error_message .= "A senha não pode estar vazia<br>";
}

if( !empty($_POST['password']) && !empty($_POST['re_password']) ) {
if($_POST['password'] != $_POST['re_password']) {
$valid = 0;
$error_message .= "As senhas não combinam<br>";	
...
$success_message = 'Senha atualizado com sucesso.';
header("Location:".BASE_URL);
die;
}
}
...
<li class="active"><a href="#tab_1" data-toggle="tab">Atualizar informações</a></li>
<li><a href="#tab_2" data-toggle="tab">Atualizar foto</a></li>
<li><a href="#tab_3" data-toggle="tab">Atualizar senha</a></li>
</ul>
...
<div class="form-group">
<label for="" class="col-sm-2 control-label">Papel <span>*</span></label>
<div class="col-sm-4" style="padding-top:7px;">
<?php echo $role; ?>
</div>
</div>
...
<div class="col-sm-6">
<button type="submit" class="btn btn-success pull-left" name="form1">Atualizar informações</button>
</div>
</div>
</div>
</div>
...
<label for="" class="col-sm-2 control-label"></label>
<div class="col-sm-6">
<button type="submit" class="btn btn-success pull-left" name="form2">Atualizar foto</button>
</div>
</div>
</div>
</div>
...
<div class="form-group">
<label for="" class="col-sm-2 control-label">Digite novamente a senha</label>
<div class="col-sm-4">
...
<label for="" class="col-sm-2 control-label"></label>
<div class="col-sm-6">
<button type="submit" class="btn btn-success pull-left" name="form3">Atualizar senha</button>
</div>
</div>
</div>
</div>
