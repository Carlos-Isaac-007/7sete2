...
$ecat_id = $row['ecat_id'];
$final_ebook_name = $row['final_ebook_name'];
}
...
$temp_msg = 'Desculoas! á apenas  '.$current_p_qty.' item(s) no stoke , mais teremos esse produto dentro de: '.$row['p_qty_update']. $lang_dias;
...
if($added == 1) {
$error_message1 = 'Esse produto já foi adicionado ao carrinho.';
} else {
...
$success_message1 = 'Produto adicionado com sucesso!';
}
...
//header('location: product?id='.$_REQUEST['id']);
}
?>