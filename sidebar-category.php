...
<a class="" href="<?=ROOT?>product-category?id=<?php echo $row['tcat_id']; ?>&type=top-category">
...
<a class="" href="<?=ROOT?>product-category?id=<?php echo $row1['mcat_id']; ?>&type=mid-category">
...
<a class="" href="<?=ROOT?>product-category?id=<?php echo $row2['ecat_id']; ?>&type=end-category">
