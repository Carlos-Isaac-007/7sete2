...
<style>
  ...
  .btn-reserve:hover { background-color: #cc7000; }
  ...
  .accordion-button:hover { background-color: #fff5eb; }

  .accordion-button:not(.collapsed) { background-color: #ffe4c2; }
  ...
  .popup-content button:hover { background-color:#cc7000; }

  @media (min-width: 992px) {
    .policy-section { margin-top: -200px; }
  }
 ...
 <!-- Popup Confirmation -->
  <div id="popup" class="popup-overlay">
    <div class="popup-content">
      ...
      <p>Obrigado por escolher a Smart Car. Em breve entraremos em contato.</p>
